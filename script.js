...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // KULLANILACAK DOĞRU Sheetbest API URL'si
    const sheetbestApiUrl = 'https://api.sheetbest.com/sheets/64ea120f-9c2e-451b-9d58-bb525e2d9308'; // Bu URL doğru olanıdır
    ...
    fetch(sheetbestApiUrl)
        ...
        .then(data => {
            ...
            data.forEach(row => {
                ...
                // Döngüyü t1'den t16'ya kadar devam ettirin (E-tablo yapınıza göre)
                for (let i = 1; i <= 16; i++) {
                    const columnKey = `t${i}`;
